...
public class MultipleObservables extends AppCompatActivity {
     ...
     */
    private static final String TAG = MultipleObservables.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiple_observables);
